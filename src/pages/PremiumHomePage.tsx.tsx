...
<div className="absolute inset-0 bg-gradient-to-br from-slate-900 viablue-900 to-slate-900">
<div className="absolute inset-0 bg-black/40"></div>
</div>
{/* Background Video or Image */}
<div className="absolute inset-0">
<div className="w-full h-full bg-gradient-to-r from-blue-600/20 topurple-600/20"></div>
</div>
<div className="relative z-10 container mx-auto px-4 h-full flex items-
center">
...
{ value: '8.5 млрд ₽', label: 'Активы под управлением', icon:
TrendingUp },
{ value: '99.8%', label: 'Уровень доверия', icon: Shield }
].map((stat, index) => (
<div key={index} className="text-center animate-slide-up" style=
{{ animationDelay: `${index * 0.1}s` }}>
<div className="inline-flex items-center justify-center w-16 h16 bg-primary-600 rounded-full mb-4">
...
<h2 className="text-4xl lg:text-6xl font-bold mb-6 bg-gradient-to-r
from-slate-900 to-blue-600 bg-clip-text text-transparent">
Почему выбирают АРТЕЛЬ?
</h2>
<p className="text-xl text-slate-600 max-w-3xl mx-auto">
Мы объединили лучшие традиции кооперативного движения с
современными технологиями и философской мудростью
</p>
</div>
...
description: 'Полная прозрачность всех операций и защита ваших
средств на уровне банковских стандартов'
},
{
icon: TrendingUp,
title: 'КВМ-токены',
description: 'Уникальная система токенизации квадратных метров
с возможностью торговли и обмена'
},
{
icon: Sparkles,
title: 'Духовное развитие',
description: 'Философия 16 конов мироздания увеличивает
доходность до 45% через осознанные решения'
},
{
icon: Users,
title: 'Сообщество единомышленников',
description: 'Присоединяйтесь к сообществу людей, стремящихся к
духовному и материальному благополучию'
},
{
icon: Building2,
title: 'Премиальная недвижимость',
description: 'Тщательно отобранные объекты в лучших районах с
высоким потенциалом роста стоимости'
},
{
icon: Star,
title: 'Персональный подход',
description: 'Индивидуальные консультации и персональные планы
накопления для каждого пайщика'
}
].map((feature, index) => (
<PremiumCard key={index} hover className="p-8 text-center">
<div className="inline-flex items-center justify-center w-16 h16 bg-gradient-to-r from-primary-500 to-blue-600 rounded-full mb-6">
...
Присоединяйтесь к тысячам семей, которые уже получили квартиры
через АРТЕЛЬ
</p>
